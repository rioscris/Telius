import { DefaultEventRootComponent, SchedulerContext, TimeGridScheduler, useMousetrap } from "@remotelock/react-week-scheduler";
...
import { classes as defaultClasses } from './styles';
